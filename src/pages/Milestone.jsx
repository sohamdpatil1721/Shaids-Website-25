  ...
  return (
    ...
    <div className="bg-bgGradient min-h-screen flex flex-col items-center px-6 md:p-10">
      ...
      <p className="text-white text-center md:text-left font-Outfit max-w-3xl md:max-w-6xl mb-8">
        Milestone is the annual event of our college, bringing together
        students, faculty, and industry professionals for a vibrant celebration
        of innovation, talent, and achievement. It features a mix of technical
        competitions, cultural performances, workshops, and guest lectures,
        providing a platform for students to showcase their skills and
        creativity. The event fosters learning, networking, and collaboration,
        making it a highlight of the academic year.
      </p>
