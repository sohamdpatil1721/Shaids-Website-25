...
const MemberCard = ({
  ...
  return (
    <div className="bg-[#5D3E98] rounded-lg  flex flex-col items-center shadow-[0_0_30px_rgba(93,62,152,0.3)] px-8 py-10 w-full  max-w-[250px] mx-auto font-Outfit h-full hover:scale-105 transition-transform duration-300">
      {/* Avatar */}
